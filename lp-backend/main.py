...
from methods.simpleSimplex import SimpleSimplex
from methods.mMethod import M_Method
...
def solve():
    ...
    if solver_input.method == "twoPhase" :
        ...
        steps, cache, solution, message= M_Method.solve(tableau, solver_input)
        ...
        steps, cache, solution ,message = SimpleSimplex.solve(tableau, solver_input)
